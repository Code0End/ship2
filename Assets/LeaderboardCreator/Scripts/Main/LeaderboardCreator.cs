...
namespace Dan.Main
{
    public static class LeaderboardCreator
    {
        ...
        private static void OnAuthorizationAttempted(string guid)
        {
            ...
            int charAmount = UnityEngine.Random.Range(0, 8); //set those to the minimum and maximum length of your string
            for (int i = 0; i < charAmount; i++)
            {
                UserGuid += glyphs[UnityEngine.Random.Range(0, glyphs.Length)];
            }
